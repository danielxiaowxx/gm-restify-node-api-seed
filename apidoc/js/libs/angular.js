 ...
 *
   <pre>
     ...
     expect(logs).toEqual(['name: misko', 'gender:male']);
   </pre>
 *
 ...
 * @param {object} $log console.logs or an object with the same interface.
 ...
 * The default implementation simply delegates to `$logs.error` which logs it into
 * the browser console.
 *
   ...
   <example>
     ...
     <file name="index.html">
       <div ng-controller="LogCtrl">
         <p>Reload this page with open console, enter text and hit the logs button...</p>
         Message:
         <input type="text" ng-model="message"/>
         <button ng-click="$logs.logs(message)">logs</button>
         <button ng-click="$logs.warn(message)">warn</button>
         <button ng-click="$logs.info(message)">info</button>
         <button ng-click="$logs.error(message)">error</button>
       </div>
     </file>
   </example>
 */
...
function $LogProvider(){
  ...
  this.$get = ['$window', function($window){
    ...
    function consoleLog(type) {
      ...
      // or we are IE where console.logs doesn't have apply so we logs at least first 2 args
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * $httpBackend, defaults, $logs, $rootScope, defaultCache, $http.pendingRequests
     */
